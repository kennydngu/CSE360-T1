...
public class ViewNewAccount {
	...
	*/
    ...
    protected static Alert alertDeadlineHasPassed = new Alert(AlertType.INFORMATION);
	...
	protected static String deadlineRaw;
	...
	*/
	...
	public static void displayNewAccount(Stage ps, String ic) {
		...
		deadlineRaw = theDatabase.getDealineGivenAnInvitationCode(theInvitationCode);
		DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss.SSSSSS");
		LocalDateTime deadline = LocalDateTime.parse(deadlineRaw, formatter);
		if (deadline.isBefore(LocalDateTime.now())) {
			alertDeadlineHasPassed.showAndWait();
			return;
		}
	...
	private ViewNewAccount() {
		...
		alertDeadlineHasPassed .setTitle("Deadline has passed");
		alertDeadlineHasPassed.setHeaderText("Deadline for the invitation has passed");
		alertDeadlineHasPassed.setContentText("This invitation has expired.");
