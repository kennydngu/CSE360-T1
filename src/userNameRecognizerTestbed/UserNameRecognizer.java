		...
		while (running) {
			...
			case 0: 
				...
				if ((currentChar >= 'A' && currentChar <= 'Z' ) ||		// Check for A-Z
					...
					// (currentChar >= '0' && currentChar <= '9' ))  note this line so that the first Char must be an alphabetic char
					nextState = 1;
			...
			case 1: 
				...
				// . -> State 2
				// Add - and _ to the accept characters check and will move to state [2]
			...
			case 2: 
				// State 2 deals with a character after a period or dash or underscore in the name.
