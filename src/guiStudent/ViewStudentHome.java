...
public class ViewStudentHome {
	...
	// GUI ARea 2: This is the discussion board system
	...
	private static void openPostViewer(entityClasses.Post p) {
	    ...
	    dlg.getDialogPane().getButtonTypes().addAll(replyBtn, editBtn, deleteBtn, javafx.scene.control.ButtonType.CLOSE);
