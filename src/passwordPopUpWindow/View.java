...
public class View {
	...
	public static void view (Pane theRoot) {
	    ...
	    setupLabelWidget(label_LongEnough, 30, 300, "Arial", 14, windowWidth-10, 
				Pos.BASELINE_LEFT);
	    // ADDED BY KENNY NGUYEN: Create a new label for if the password meets the length maximum of 32
		...
		// ADDED BY KENNY NGUYEN: added label_ShortEnough
	...
	static protected void resetAssessments() {
	    ...
	    // ADDED BY KENNY NGUYEN: Checker label for if the password is short enough has to be less than 32 characters
	    label_ShortEnough.setText("Less than 32 characters - Not yet satisfied");
