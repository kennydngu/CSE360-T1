...
public class PasswordEvaluationTestingAutomation {
	...
	private static void displayEvaluation() {
		...
		// ADDED BY KENNY NGUYEN: ADD foundShortEnough
		if (passwordPopUpWindow.Model.foundShortEnough)
			System.out.println("At most 32 characters - Satisfied");
		else
			System.out.println("At most 32 characters - Not Satisfied");
	}
}
