	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 1: 
				...
				//  2: a period, a minus or a underscore that transitions to state 2 
		...
		case 1:
			...
			if (userNameSize < 4) {
				...
				userNameRecognizerErrorMessage += 
					"A UserName character may only contain the characters A-Z, a-z, 0-9, and '-', '_' or '.'\n";
				return userNameRecognizerErrorMessage;
			}
			else {
					// UserName is valid
		...
		case 2:
			...
			userNameRecognizerErrorMessage +=
				"A UserName character after a period, a minus or a underscore must be A-Z, a-z, 0-9.\n";
			return userNameRecognizerErrorMessage;
